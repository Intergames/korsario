...
<div id="MainBody">
    <div id="TituloFormulario">
      <p align="center">B&uacute;squeda de clientes.</p>
    ...
    <table width="880" border="0"> 
      <tr>
        ...
        Sucursal: 
        <select name="LstSucursales" id="LstSucursales" class="LstSucursales" onchange="cargaXMLClientes('rutinaBuscarClientes.php','1')">
        ...
        <td width="84"><input type="button" name="BtnBuscar" id="BtnBuscar" value="Buscar" onclick="cargaXMLClientes('rutinaBuscarClientes.php','1')" /></td>
      </tr>
    </table>                 
    <table width="881">
      <tr>
          <td width="224">Mostrar
            <select name="Cantidad" id="Cantidad" class="Cantidad" onchange="cargaXMLClientes('rutinaBuscarClientes.php','1')">
          ...
          <td width="77"><select name="LstOrdenar" id="LstOrdenar" class="LstOrdenar" onchange="cargaXMLClientes('rutinaBuscarClientes.php','1')">
          ...
          <td width="118"><select name="LstTipo" id="LstTipo" class="LstTipo" onchange="cargaXMLClientes('rutinaBuscarClientes.php','1')">

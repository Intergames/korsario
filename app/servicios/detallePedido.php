          ...
          <div id="FondoFormularios">
            <center>
              ...
              <?php 
                ...
                echo "
                <tr>
                    <th scope='col' width='90'>Imágen</td>
                    <th scope='col' width='100'>Descripción</td>
                    <th scope='col' width='60'>Cantidad</td>
                    <th scope='col' width='60'>Precio</td>
                    <th scope='col' width='60'>Neto</td>
                ...
                $SumantoriaIVA = 0;
                $SumantoriaTotal = 0;
                $query_pedido = "SELECT detalle_pedido.IdProducto, detalle_pedido.Cantidad, detalle_pedido.Precio, detalle_pedido.Descuento1, detalle_pedido.Neto, detalle_pedido.IVA ,detalle_pedido.Total, productos.RutaImagen, productos.Descripcion  FROM detalle_pedido JOIN productos ON detalle_pedido.IdProducto = productos.IdProducto WHERE detalle_pedido.Folio = '$Folio'";
                ...
                while($row = mysql_fetch_array($result_pedido)) { ?>
                   ...
                   ?>
                    <td align="center"><img src=http://www.uruapanmovil.com/ventas/assets/img/<?php echo $row['RutaImagen']; ?> width="15%"></td> <!-- Imagen -->
                    <td align="center"><?php echo $row['Descripcion']; ?></td> <!-- Descripcion -->
                    <td align="center"><?php echo "$".number_format(round($row['Cantidad'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td> <!-- Cantidad -->
                    <td align="center"><?php echo "$".number_format(round($row['Precio'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td> <!-- Precio -->
                    <td align="center"><?php echo "$".number_format(round($row['Cantidad'] * $row['Precio'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td> <!-- Neto -->
                    <td align="center"><?php echo "$".number_format(round($row['Descuento1'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td> <!-- Descuento1 -->
                    <td align="center"><?php echo "$".number_format(round($row['IVA'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td>
                    <td align="center"><?php echo "$".number_format(round($row['Total'], 2, PHP_ROUND_HALF_DOWN),2,".",","); ?></td>
                 </tr>
              <?php
            ...
            <div style="float:right;">
              <table border='0' width = '160px'>
                ...
                <tr><td>Total descuentos: </td><td align="right"><?php echo "$".round($SumatoriaDescuento,2, PHP_ROUND_HALF_UP); ?></td></tr>  

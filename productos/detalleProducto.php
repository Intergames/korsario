...
<head>
    ...
    $detalle_producto = mysql_fetch_assoc($productos);    

    $IdSucursal = $detalle_producto['IdSucursal'];
    ...
    ?>
<title>Detalle de producto - Refaccionaria Terry's</title>
</head>
<body>
    <div id="Cabecera">
          ...
          <div id="FondoFormularios">
            <center>
              <table border="0">
                ...
                <tr>
                  <td>Imagen:</td>
                    <td><?php echo $detalle_producto['RutaImagen']; ?></td>
                </tr>
                <tr>
                  <td>Codigo:</td>
                  <td><?php echo $detalle_producto['Codigo'] ?></td>
                </tr>                
                <tr>
                  <td>Cantidad:</td>
                ...
                <tr>
                  ...
                  <td><?php echo $detalle_producto['Descripcion'] ?></td>
                </tr>
                <tr>
                  <td>Marca:</td>
                  <td><?php echo $detalle_producto['Marca'] ?></td>
                </tr>
                <tr>
                  <td>Precio de compra:</td>
                  <td><?php echo $detalle_producto['PrecioCompra'] ?></td>
                </tr>
                <tr>
                  <td>Precio de venta:</td>
                  <td><?php echo $detalle_producto['PrecioVenta'] ?></td>
                </tr>
                <tr>
                  <td>Precio de venta especial:</td>
                  <td><?php echo $detalle_producto['PrecioVentaEspecial'] ?></td>
                </tr>
                <tr>
                  <td>Inventario Bajo:</td>
                  <td><?php echo $detalle_producto['InventarioBajo'] ?></td>
                </tr>
                <tr>
                  <td>Medida:</td>
                  <td><?php echo $detalle_producto['Medida'] ?></td>
                </tr>
                <tr>
                  <td>Unidad de Medida:</td>
                  <td><?php echo $detalle_producto['UnidadMedida'] ?></td>
                </tr>
                <tr>
                  <td>Comentario:</td>
                  <td><?php echo $detalle_producto['Comentario'] ?></td>
                </tr>
                <tr>

...
conexion();
$sql = "SELECT detalle_pedido.Cantidad, detalle_pedido.Precio, detalle_pedido.Descuento1, detalle_pedido.Neto, detalle_pedido.IVA, detalle_pedido.Total,   FROM `detalle_pedido` JOIN productos ON detalle_pedido.IdProducto = productos.IdProducto WHERE Folio = 'Folio'";
$result = query($sql);
